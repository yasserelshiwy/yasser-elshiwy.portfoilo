export const myProjects = [
  ...
  },
  {
    ...
    image: "/img/mantu.png",
    liveDemo: "https://mantu-taupe.vercel.app/",
    gitHubLink: "https://github.com/yasserelshiwy/mantu",
    discription:
      "Mantu  – E-commerce Website (React & Tailwind CSS) A clean and responsive e-commerce UI built with React and Tailwind CSS. It features a modern product listing layout, product detail pages, and a scalable component structure. Designed for a smooth user experience with a mobile-first approach. Currently under development with plans to integrate cart, filtering, and checkout features.",
    id: "2",
  },
  {
    titel: "Well Food",
    Category: ["JavaScript", "BootStrap"],
    image: "/img/wellfood.png",
    liveDemo: "https://well-food.vercel.app/",
    gitHubLink: "https://github.com/yasserelshiwy/Well-Food",
    discription:
      "Well Food – A responsive recipe discovery website built with Bootstrap, JavaScript, and GSAP. It showcases random meals with categories, ingredients, and cooking instructions, enhanced by smooth animations and an engaging user experience.",
    id: "3",
  },
  {
    titel: "Rose",
...

  {
    ...
    discription:
      "Landwind is a page for Building digital products & brands. It is made using Tailwind and supports dark mode feature which enables it to support all media and screens big and small.",
    id: "9",
  },
  {
    titel: "Bookmarker",
