// @ts-nocheck
import profile from "../../assts/img/profile-modified.png";
        ...
        <div className="grow  ">
          <div className=" relative min-h-32">
            <motion.img
              ...
              src={profile}
              className="w-35 border-2 border-gray-300 shadow-xs  shadow-gray-300 dark:border-[#fff7ed7e] rounded-full"
              alt=""
            />
            <div className="text-blue-500 text-right  absolute left-[118px] bottom-1 ">
              <VerifiedIcon />
            </div>
          </div>
          <motion.h1
          ...
          <div className="flex items-center gap-5 my-5 text-2xl dark:text-gray-300 ">
            ...
            <a href="/cv/Yasser_Emad-Front-End-developer.pdf" download>
              <button className="cursor-pointer hover:scale-110 hover:text-green-300  transition-all duration-200">
                <i className="fa-solid fa-download"></i> <span>Cv</span>
              </button>
            </a>
          </div>
        </div>
